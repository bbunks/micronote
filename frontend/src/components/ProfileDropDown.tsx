...
export function ProfileDropDown() {
  ...
  return (
    <div className="relative">
      <Menu>
        <Menu.Button className="px-6 py-3 rounded-full bg-neutral-100 text-primary hover:bg-neutral-200 hover:text-primary-dark active:bg-neutral-300 active:text-primary-darker flex gap-2 items-center">
          Account
